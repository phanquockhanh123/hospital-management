                ...
                <div class="card-body">
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><a href="{{ route('doctor_departments.show', $doctorDepartment) }}">{{ $doctorDepartment->id }}</a></td>
                        ...
                        <td>
                          <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-danger" data-toggle="modal"
                              data-target="#deleteModal{{ $doctorDepartment->id }}" style="color: red;">
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="deleteModal{{ $doctorDepartment->id }}" tabindex="-1" role="dialog"
                          aria-labelledby="deleteModalLabel{{ $doctorDepartment->id }}" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="deleteModalLabel{{ $doctorDepartment->id }}">Xóa loại giường</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                              <div class="modal-body">
                                Bạn có chắc chắn muốn xóa loại giường "{{ $doctorDepartment->name }}" không? Hành động này không
                                thể hoàn tác!
                              </div>
