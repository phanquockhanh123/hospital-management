...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
                        ...
                        <div class="card-body">
                            <form action="{{ route('prescriptions.store') }}" method="POST">
                                ...
                                <div class="card-header" style="display: flex!important"> 
                                    ...
                                    <button style="margin-left: 80%;" class="btn btn-primary" id="btAddMedicine">Thêm thuốc</button>
                                </div>
                                ...
                                <table class="table" id="table">
                                    ...
                                    <tbody>
                                      <tr id="sectionMain">
                                        ...
                                        <td>
                                            <svg style="color: red" xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
        ...
        <script>
            document.getElementById("btAddMedicine").onclick = function() {
